...
{ 
	public class cls_PacketHandler
	{
		...
		{
			string sPack = "HMATO";
		    sPack += xbFUNCCODE.ToString("X02");
			sPack += xbCMD0.ToString("X02");
			sPack += xbCMD1.ToString("X02");
			sPack += xbCMD2.ToString("X02");
			sPack += xbCMD3.ToString("X02");
			sPack += xbCMD4.ToString("X02");
			sPack += xbLENGTH.ToString("X02");
			//sPack += xbDATA.ToString("X02");
